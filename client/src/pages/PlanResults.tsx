                      ...
                      <div className="flex-1">
                        <div className="flex items-center gap-2">
                          <h5 className="font-medium text-gray-800">
                            {stop.stop_type === 'origin' ? 'จุดเริ่มต้น' : (stop.name || stop.address || 'ไม่ระบุ')}
                          </h5>
                          <span className={`px-2 py-1 rounded text-xs ${
                            ...
                            {stop.stop_type === 'origin' ? 'จุดเริ่มต้น' :
                             ...
                             stop.stop_type === 'pickup' ? 'รับสินค้า' : (stop.stop_type || 'ไม่ระบุ')}
                          </span>
                        </div>
                        <p className="text-sm text-gray-600 mt-1">{stop.address || 'ไม่ระบุที่อยู่'}</p>
